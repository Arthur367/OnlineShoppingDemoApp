...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo() {
        ...
        Toast.makeText(SettingsActivity.this, "Account Info updated Succesfully", Toast.LENGTH_SHORT).show();
        finish();
    ...
    private void uploadImage() {
        ...
        progressDialog.setMessage("Please wait, while we are updating you account info");
